...
8. Record macOS Sequoia 15 as the minimum and freeze the compatible Electron line.
...
1. Create Electron `43.2.0` main, sandboxed preload, renderer, and the app-server child composition root for macOS Sequoia 15+ and Windows 11; package and sign Node `22.23.2` as the app-server runtime instead of using Electron's Node mode.
...
1. Run the full macOS Sequoia 15+ and Windows 11 matrix for sessions, credentials, process trees, leases, worktrees, Browser, downloads, tray behavior, and packaging.
...
5. Does the same fixture behave on macOS Sequoia 15+ and Windows 11?
