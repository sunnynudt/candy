...
| 6. Local control/workspaces | Blocked     | Approval policy, clean child env, serial mutation lane, secret-aware Apply guard, argument-array Git worktree manager, binary-safe tracked/untracked Apply service, Desktop Task Worktree handoff with persisted association, dirty/base/conflict/untracked and Windows-path Apply matrix, real Git fixture, and gated Rust protocol compile pass | Native containment, Job Object, Windows 11 host worktree/reparse-point matrix, security review        |
