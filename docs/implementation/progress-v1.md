...
| --------------------------- | ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| 0. Compatibility Gate       | In progress | Accepted architecture, conditional Gate reports, and the macOS DeepSeek live matrix at 7/7                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Live MiniMax/Token Plan evidence, exact macOS `26.5.2` regression when that compatibility claim is required, and native/security verification |
...
| 9. Release hardening        | Pending     | Current macOS Tahoe `26.x` primary smoke is repeatable; exact macOS `26.5.2` regression runner and Windows 11 x64 unsigned packaged development smoke are tracked separately                                                                                                                                                                                                                                                                                                                                                     | Remaining current-host and exact-baseline macOS evidence, Windows matrices; signed packaging, recovery, evidence      |
...
- The current MacBook Pro reports macOS Tahoe `26.6.1` arm64. Current-host acceptance can run here; the exact `26.5.2` regression run remains pending until that host is available.
