...
Post-`50074c2` current-host revalidation: `npm run acceptance:macos` passes **14/14** on macOS `26.6.1` arm64 with Node `22.23.2`/npm `10.9.8`; its embedded deterministic `npm run check` passes **241/241**. Workspace writes now open and validate the target handle before truncating through that handle. The code checkpoint is published at `50074c2ee25ccd3d161d5096a8b6c3fce06cd6f9` with matching remote SHA. Fresh standard scan `721c4ab5-ccdf-4052-9a28-b695323b3b70` is bound to `50074c2` and reports **4 open findings (all medium)**; the local write ordering change lowers one destructive race window but does not establish descriptor-relative/reparse-safe closure, and parent validation fallback was used, so this is not a security clearance. Exact `26.5.2` remains unavailable on this `26.6.1` host; Windows 11, independent G2, signing, and final V1 acceptance remain open. `.omo/` remains user-owned and untracked.
...
Issue #4 is the current delivery boundary. V1 is the macOS/Windows 11 TUI only; Desktop, Browser Workspace, cross-client handoff, and their dependent long-running workflows are V2 and must not block the TUI release decision. For this work packet, the user has explicitly deferred Windows execution; that deferral is not a Windows acceptance claim. The current code checkpoint is `50074c2`; its macOS acceptance is separately source-bound to `50074c2` and passes 14/14 on macOS `26.6.1` arm64 with Node `22.23.2`/npm `10.9.8`, deterministic checks 241/241, bounded credential-redacted tool lifecycle evidence, presence-only credential and revocation evidence, Pi-backed projection/persistence/workspace mutation/review-restart/cancellation evidence, and the TUI-only terminal matrix. The latest standard scan `721c4ab5-ccdf-4052-9a28-b695323b3b70` is bound to that current code checkpoint (the later commits are documentation-only) and reports four medium residual findings; it is not a security clearance. Exact macOS `26.5.2` preflight is blocked on this host, and macOS G2, signing, and final V1 acceptance remain open. Windows evidence remains separately pending and is not substituted by macOS evidence.

| Phase                           | Status      | Evidence                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Remaining                                                                                                                                |
| ------------------------------- | ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| 0. Compatibility Gate           | In progress | Current source `50074c2` passes the pinned Node/npm toolchain assertion, deterministic checks 241/241, current macOS TUI acceptance 14/14, and source-bound platform preflight reports                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Exact macOS `26.5.2` regression, Windows 11 evidence, remaining native/security verification, and release evidence                         |
...
| 9. Release hardening            | In progress | Current code `50074c2` passes `npm run check` 241/241 and source-bound macOS acceptance 14/14; workspace/worktree/session hardening checkpoints, credential/provider gates, stable `candy` bin, and TUI-only scope are recorded; standard scan `721c4ab5` reports four medium residual findings                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Windows 11 host, exact-baseline host, descriptor/reparse-safe residual security work, platform Trusted Shell G2, signing, and final V1 evidence |
