...
| G1-KEYRING        | Product owner + implementation agent     | In progress | ACC-02 OS credential acceptance                            | Adapter and Candy-owned service/account mapping pass a temporary macOS Keychain fixture; verify signed package path, deletion, and Windows Credential Manager without exposing complete credentials.                  |
