...
| G0-MAC            | Product owner                            | In progress | Complete macOS acceptance                                  | Run the required matrix on macOS `26.5.2` Apple Silicon and attach sanitized evidence.                                                                                                                            |
...
- TUI and signed Desktop installation, launch, packaged Node app-server lifecycle, and responsiveness measurements.
