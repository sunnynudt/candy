...
| G0-MAC            | Product owner                            | In progress | Complete macOS acceptance                                  | On clean revision `327b0e529f403a207941e0d9f28a3c2ba45c83d3`, the 2026-08-11 macOS runner passes 12/12 deterministic/native/Runtime/TUI/app-server/Electron/package/recovery steps with 94 tests on macOS `26.5.2` arm64; the sanitized report is `out/acceptance/macos/latest.md`. Continue with ACC-12 ten-run responsiveness, full UI/cross-client recovery and Browser matrix, live-provider, signing, and native-security evidence. |
