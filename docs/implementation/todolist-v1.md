...
- ◐ 在 Worktree 基线恢复后，工具链、Runtime/session-remap、TUI、Desktop App Server、Worktree/Apply 的确定性 macOS 基线和打包 smoke 已通过，并生成了新的 macOS 脱敏证据；ACC-12 十轮响应性矩阵、完整恢复/Browser 矩阵和完整 macOS 接受矩阵仍待完成。
