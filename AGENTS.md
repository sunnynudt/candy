...
- Support the current macOS `26.5.2` Apple Silicon acceptance baseline and Windows 11.
...
- Verify relevant behavior on macOS `26.5.2` Apple Silicon and Windows 11 before claiming cross-platform support.
