...
function registerIpcHandlers(): void {
  ...
  ipcMain.handle(
    ...
    async (
      ...
      if (trustedShell === true)
        throw new Error("Personal Preview Shell is available only in the macOS TUI.");
